...
|---|---|---|---|
| 1 | `slide-01.png` | "good morning from 1,400 km away" · "its 6am here why are u awake" · "exactly. 11 DAYS" | `long distance for 2 years` |
| 2 | `slide-02.png` | "i hate the goodbye bit at the airport" · "u always say i know" | |
| 3 | `slide-03.png` | "when do i see u next" · "working on it" · "a thing" | |
| 4 | `slide-04.png` | "how many times have we met halfway" · "6" · "paris. the train to porto. that awful airport in frankfurt" | `why is he counting` |
| 5 | `slide-05.png` | the link · "all the way to the last page" · "is this a passport" · "keep going" | |
...
Passport at tryethos.io. Premium, so the comment answer is a sale. The globe is 3D, so shoot
it on the phone rather than screen-recording a laptop.
...
1. `paris. it rained the entire time. best weekend of my life.`
2. `the train to porto. u slept on my shoulder for three hours and i didn't move.`
3. `frankfurt airport. forty minutes. the worst croissant either of us has ever had.`
4. `bordeaux. u said the wine was "fine". it was not fine.`
5. `brussels. u cried at the station. i pretended i didn't.`
6. `madrid. the last goodbye. i promised myself it was the last one.`

### The message (paste as written)

> Nina.
>
> Six times we've met halfway. Paris in the rain. The train to Porto where you fell asleep on
> my shoulder and I didn't move for three hours. That airport in Frankfurt where we had forty
> minutes and spent them eating the worst croissant of our lives.
>
> I've done the maths. We've spent more time saying goodbye than most people spend together
> in a year.
>
...
Caption: `6 times we met halfway. then he said he was done with halfway 😭`

Tags: `#longdistance #ldr #boyfriend #relationshiptok #textstory #fyp`

Sound: slow and hopeful. Long distance audiences respond to songs about distance, and there
is always one trending.
...
- Long distance comment sections turn into people sharing their own countdowns. Reply to
  those. They keep the post alive for weeks.
