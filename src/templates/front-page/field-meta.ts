...
export const fieldMeta: Record<"en" | "es", Record<string, FieldMeta>> = {
  en: {
    ...
    ads: { label: "Classified ads", help: "Short and silly.", addLabel: "Add an ad", placeholder: "FOR SALE: one slightly used snore machine. Free to a good home." },
  ...
  es: {
    ...
    ads: { label: "Anuncios clasificados", help: "Cortos y tontos.", addLabel: "Añadir un anuncio", placeholder: "SE VENDE: máquina de roncar, poco uso. Gratis a buen hogar." },
